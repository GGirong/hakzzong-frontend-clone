...
export const StudySubjectDetailView = props => (
    <>
        ...
        <div className="mt-5 mb-5 d-flex justify-content-end">
            ...
            <input
                className="d-inline-block input border w-30 rounded-0 p-3 border-dark text-center"
                value="0"
            />
        </div>

        <div className=" row mt-3 pb-3 mb-5">
            <div className="offset-1 col-5 justify-content-center align-items-center d-flex">
                <button
                    type="button"
            ...
            <div className="col-5 justify-content-center align-items-center d-flex">
                <button
                    type="button"
                    className="btn btn-outline-secondary btn-lg rounded-0 btn-block"
                >
                    다시 제출하기
                </button>
            </div>

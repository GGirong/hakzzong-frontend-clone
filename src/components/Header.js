...
export const Header = (props = { user: {} }) => {
    ...
    // const acceptedMissionReports = appContextState.missionReports.filter(
    //     missionReport => missionReport.inspection_status === 'ACCEPTED',
    // );
    // const rejectedMissionReports = appContextState.missionReports.filter(
    //     missionReport => missionReport.inspection_status === 'REJECTED',
    // );
    // const ongoingMissionReports = appContextState.missionReports.filter(
    //     missionReport => !missionReport.inspection_status,
    // );
    ...
    return (
        <header className="pt-3 pb-3 row">
            <div className="col-4 p-0">
                <h4 onClick={e => handleLinkClick(e, '/')}>학쫑</h4>
            </div>
                    ...
                    <div className="col-8 p-0">
                        <div className="row">
                            <div className="col-4 bg-info d-flex align-items-center justify-content-center">
                                <a id="show-rewards-btn" className="btn">
                            ...
                            <div className="col-3 d-flex align-items-center justify-content-center">
                                ...
                                <div className="justify-content-center align-items-center profile-name">
                                    <h5 className="mb-0 ml-3">
                                        <b>{appContextState.user.username}</b>님
                                    </h5>
                                </div>
                            </div>
                        </div>
